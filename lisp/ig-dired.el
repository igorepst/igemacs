...
(use-package dired-rainbow
  :config
  (defconst ig-src-files-extensions '("ahk" "asm" "asp" "aspx" "bat" "cfg" "cnf" "css" "csv" "dmp" "htm" "html" "inc" "ini" "jad" "java" "js" "json" "jsp" "lib" "log" "o" "php" "pro" "rc" "reg" "rss" "scpt" "src" "usr" "vbs" "xhtml" "xml" "xsd" "xsl" "xslt") "Source code files")
  (defconst ig-images-files-extensions
    '("3d" "3ds" "abr" "ai" "ani" "arw" "bmp" "c4d" "cdr" "cdt" "cpt" "cr2" "crw" "csh" "dcr" "dds" "dgn" "dib" "dng" "drw" "dt2" "dwfx" "dwg" "dxf" "emf" "emz" "eps" "fla" "fpx" "gif" "icns" "ico" "icon" "ics" "jpeg" "jpg" "lcf" "max" "mdi" "mrw" "nef" "odg" "orf" "pcd" "pcx" "pic" "png" "psb" "psd" "psdx" "pts" "ptx" "pzl" "raf" "raw" "rw2" "sda" "skp" "stl" "sup" "svg" "tga" "thm" "tif" "tiff" "u3d" "vsdx" "wbmp" "wdp" "webp" "wmf" "x_t") "Images files.")
  (defconst ig-archives-files-extensions
    '("000" "001" "002" "003" "004" "005" "006" "007" "008" "009" "010" "7z" "7z.001" "7z.002" "7z.003" "7zip" "a00" "a01" "a02" "a03" "a04" "a05" "ace" "air" "apk" "appxbundle" "arc" "arj" "asec" "bar" "bin" "c00" "c01" "c02" "c03" "cab" "cbr" "cbz" "ccd" "cso" "cue" "daa" "dao" "deb" "dlc" "dmg" "gz" "gzip" "hqx" "img" "inv" "ipa" "iso" "isz" "jar" "mdf" "mds" "mdx" "msu" "nbh" "nrg" "pak" "r00" "r01" "r02" "r03" "r04" "r05" "r06" "r07" "r08" "r09" "r10" "rar" "rpm" "sis" "sisx" "sit" "sitd" "sitx" "tao" "tar" "tar.gz" "tc" "tgz" "toast" "uax" "uif" "vcd" "webarchive" "xap" "z01" "z02" "z03" "z04" "z05" "zab" "zip") "Archives files.")
  (defconst ig-exec-files-extensions
    '("alx" "app" "application" "appx" "blf" "btm" "cmd" "com" "cpl" "dat" "dll" "drv" "dump" "elf" "evtx" "exe" "gadget" "idx" "inf" "jse" "kext" "key" "lnk" "msi" "mui" "ocx" "prg" "rom" "scr" "sfcache" "shs" "swp" "sys" "vbe" "vxd" "wsf" "wsh")
    "Executable files.")
  (defconst ig-docs-files-extensions
    '("1st" "abw" "accdb" "accdt" "ashx" "atom" "aww" "azw" "azw3" "azw4" "bc" "bc!" "chm" "class" "cnt" "crdownload" "csv" "dbx" "djvu" "doc" "docm" "docx" "dot" "dotm" "dotx" "download" "eml" "eng" "epub" "fb2" "gdoc" "gsheet" "gslides" "html" "iba" "ibooks" "ind" "indd" "keynote" "lit" "lrc" "lst" "mdb" "mht" "mobi" "mpd" "mpp" "mpt" "nfo" "numbers" "odf" "ods" "odt" "oft" "one" "onepkg" "opml" "ott" "oxps" "pages" "part" "partial" "pdf" "plist" "pmd" "pot" "potx" "pps" "ppsx" "ppt" "pptm" "pptx" "prn" "ps" "pst" "pub" "pwi" "rep" "rtf" "sdc" "sdd" "sdw" "snp" "srt" "sub" "sxc" "sxw" "tbl" "text" "thmx" "torrent" "tpl" "txt" "vsd" "wlmp" "wpd" "wps" "wri" "xls" "xlsm" "xlsx" "xps")
    "Document files.")
  (defconst ig-media-files-extensions
    '("264" "3g2" "3ga" "3gp" "aac" "aiff" "amr" "ape" "arf" "asf" "asx" "avi" "bik" "cda" "dash" "dvf" "dvr" "flac" "flv" "gp4" "gp5" "gpx" "h264" "logic" "m2t" "m2ts" "m3u" "m4a" "m4b" "m4p" "m4v" "midi" "mkv" "mod" "mov" "mp3" "mp4" "mpeg" "mpg" "mswmm" "mts" "mu8" "ogg" "ogv" "pcm" "prproj" "rec" "rmvb" "snd" "sng" "swf" "tod" "tp" "ts" "vob" "wav" "webm" "wma" "wmv" "wpl") "Media files.")
  (setq dired-rainbow-date-regexp (concat "\\(?:[0-3][0-9]/[0-1][0-9]/[0-9][0-9]" ig-time-style-space "[0-2][0-9]:[0-5][0-9]\\)"))
  (dired-rainbow-define ig-src-files-extensions "#0fb7d0" ig-src-files-extensions t)
  (dired-rainbow-define ig-media-files-extensions "#6fb7d8" ig-media-files-extensions t)
  (dired-rainbow-define ig-images-files-extensions "#9397b7" ig-images-files-extensions t)
  (dired-rainbow-define ig-archives-files-extensions "#9fb696" ig-archives-files-extensions t)
  (dired-rainbow-define ig-docs-files-extensions "#21a184" ig-docs-files-extensions t)
  (dired-rainbow-define ig-exec-files-extensions "#d787a5" ig-exec-files-extensions t)
  (dired-rainbow-define-chmod ig-exec-files-chmod "#d787a5" "-.*x.*" t))
